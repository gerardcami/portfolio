    ...
    <ul className="flex items-center justify-start gap-x-4">
      {links.map((link, index) => (
        ...
        >
          ...
          <span className="absolute left-1/2 top-full mt-2 w-max -translate-x-1/2 rounded bg-black px-2 py-1 text-xs text-white opacity-0 transition-opacity duration-300">
            {link.tooltip}
